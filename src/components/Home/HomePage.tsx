...
const HomePage: React.FC<HomePageProps> = ({ onLogin, onGetStarted }) => {
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900">IoT Showroom</span>
            </div>
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="#demo" className="text-gray-600 hover:text-blue-600 transition-colors font-medium">Live Demo</a>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              <div className="p-12">
                ...
                <button className="px-8 py-4 bg-gradient-to-r from-blue-600 to-emerald-600 text-white rounded-xl hover:shadow-lg transition-all font-semibold flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">IoT Showroom</span>
              </div>
              <p className="text-gray-400 text-sm">
                The comprehensive platform for IoT project management in academic settings.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="hover:text-white transition-colors">About FPTU</a></li>
